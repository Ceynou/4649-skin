...
local JudgementImageAnimationNotPerfect = {
	class = "ImageAnimationView",
	-- x = -32 - 32, y = 120 - 32, w = 64 + 64, h = 64 + 64,
	x = 0, y = 120, w = 128, h = 128, ox = 0.5, oy = 0.5,
	transform = osupixelsCentered,
...
local JudgementAnimation = {
	class = "JudgementView",
	key = "gameController.rhythmModel.scoreEngine.scoreSystem.judgement.counters.soundsphere",
	judgements = {
